...
import { createRestaurantDetailTemplate, createRestaurantReviewTemplate } from '../utils/template-creator';
...
const Detail = {
  ...
  async afterRender() {
    ...
    restoContainer.innerHTML = createRestoDetailTemplate(detail);  // Changed to createRestoDetailTemplate
