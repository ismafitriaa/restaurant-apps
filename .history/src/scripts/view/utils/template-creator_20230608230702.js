...
<div class="post-item" id="post-item">
  <img class="lazyload" data-id="gambar"
    data-srcset="${restaurant.pictureId ? `${CONFIG.SMALL_BASE_IMAGE_URL}${restaurant.pictureId} 480w, ${CONFIG.MEDIUM_BASE_IMAGE_URL}${restaurant.pictureId} 800w` : '../../../../dist/images/heros/hero-image_2.jpg 480w, ../../../../dist/images/heros/hero-image_2.jpg 800w'}"
  ...
  <div class="post-item__content">
    ...
    <h1 class="post-item__title" data-id="detail">
